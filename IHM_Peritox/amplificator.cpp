...
QString Amplificator::puissance(QString nb, int sortie)
{
    switch(nb.size())
    {
    case 1: nb = "000" + nb; break;
    case 2: nb = "00" + nb; break;
    case 3: nb = "0" + nb; break;
    }
    ...
    switch(sortie)
    {
    case 1: m_trame = "rf5010" + m_trame; break;
    case 2: m_trame = "rf5020" + m_trame; break;
    case 3: m_trame = "rf5030" + m_trame; break;
    case 4: m_trame = "rf5040" + m_trame; break;
    case 5: m_trame = "rf5050" + m_trame; break;
    case 6: m_trame = "rf5060" + m_trame; break;
    }
